...
jest.mock('./ProductCard', ()=> ({ProductCard: ({datum} : ProductCardProps)=> {
	const {name, price, image} = datum
	return <div>{name}  {price}  {image}</div>
}}))
const useProductsMock = useProducts as unknown as jest.Mock<Partial<ReturnType<typeof useProducts>>>

describe('Home', ()=> {
	describe('while loading', ()=> {
		/* it.todo('renders loaders') */
		it('renders loader', ()=> {
